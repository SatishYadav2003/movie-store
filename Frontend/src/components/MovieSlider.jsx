              ...
              <div key={idx}>
                ...
                <div className="flex flex-col md:hidden items-center justify-center p-4 space-y-3">
                  ...
                  <div className="flex flex-col w-full gap-2 mt-2">
                    <Link
                      to={`/movie-detail/${movie.movie_id}?isDownload=true`}
                      className="px-4 py-2 bg-green-500 hover:bg-green-600 transition-all text-white font-semibold rounded text-center"
                    >
                      🎬 Download Movie
                    </Link>
                    <Link
                      to={`/movie-detail/${movie.movie_id}?isWatch=true`}
                      className="px-4 py-2 bg-blue-500 hover:bg-blue-600 transition-all text-white font-semibold rounded text-center"
                    >
                      🎥 Watch Movie
                    </Link>
                  </div>
                  ...
                  <div className="w-1/2 h-full flex items-center px-12 z-20">
                    <div className="space-y-4 text-white">
                      ...
                      <div className="flex flex-wrap gap-4 mt-4">
                        <Link
                          to={`/movie-detail/${movie.movie_id}?isDownload=true`}
                          className="px-4 py-2 bg-green-500 hover:bg-green-600 transition-all text-white font-semibold rounded"
                        >
                          🎬 Download Movie
                        </Link>
                        <Link
                          to={`/movie-detail/${movie.movie_id}?isWatch=true`}
                          className="px-4 py-2 bg-blue-500 hover:bg-blue-600 transition-all text-white font-semibold rounded"
                        >
                          🎥 Watch Movie
                        </Link>
                      </div>
